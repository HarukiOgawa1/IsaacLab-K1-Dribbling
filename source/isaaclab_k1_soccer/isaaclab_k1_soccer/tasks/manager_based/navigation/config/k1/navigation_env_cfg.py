...
"""K1 navigation environment using a pre-trained flat-walking policy."""
...
# ---------------------------------------------------------------------------
# Low-level locomotion policy (trained K1 flat-walking policy)
# ---------------------------------------------------------------------------
LOW_LEVEL_ENV_CFG = K1FlatEnvCfg()

# Path to the exported TorchScript policy from the locomotion training run.
# Update this path when using a newer checkpoint.
K1_FLAT_POLICY_PATH = (
...
class NavigationEnvCfg(ManagerBasedRLEnvCfg):
    """K1 navigation environment using pre-trained flat walking policy."""
